    ...
    <div class="login-clean">
        <form method="post" action="register.php" id="register-form">
            ...
            <div class="form-group">
                <h1 id="login-head">REGISTER</h1>
                <hr id="pink-hr">
                <input class="form-control" type="text" name="username" placeholder="Username" required="" id="register-username-field" minlength="2" maxlength="20">
            </div>
            <div class="form-group">
                <input class="form-control" type="password" name="password" placeholder="Password" required="" id="register-password-field">
            </div>
            <div class="form-group">
                <button class="btn btn-primary btn-block" onclick="submitRegister()">Register</button>
            </div>
            <a class="forgot" href="login.php"><h6>Already have an account? <br> Login here</h6></a>
        </form>
    </div>
